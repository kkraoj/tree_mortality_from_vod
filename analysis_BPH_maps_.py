...
data_label="VOD \nanomaly"
mort_label='Live basal area\n$(m^2ha^{-1})$'

#----------------------------------------------------------------------


mort=store['BPH_%03d_grid'%grid_size]
mort=mort[mort>0]
...
for year in year_range:   
    ...
    plot_mort=m.scatter(lats, lons,s=marker_size,c=mort_plot,cmap='PuRd_r',\
                        marker='s',\
...
cb0.ax.text(1,0.9,'  $(m^2ha^{-1})$',horizontalalignment='left',fontsize=10)
